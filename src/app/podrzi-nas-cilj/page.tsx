...
const MapZivotinja = dynamicImport(() => import("@/components/ui/MapZivotinja"), {
  ssr: false,
  loading: () => (
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <section className="rounded-2xl border p-8">
        <h1 className="text-3xl font-bold">Podrži naš cilj</h1>

        <p className="mt-3 max-w-2xl text-sm opacity-80">
          Svaka podrška znači novu šansu za napuštene životinje. Zajedno možemo
          obezbediti sigurnost, brigu i dom.
        </p>
      </section>
      ...
      <section className="mt-8 grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-2xl border p-6">
          ...
          <p className="mt-2 text-sm opacity-80">
            Deljenjem objava, volontiranjem ili donacijama doprinosiš većoj
            vidljivosti i boljim uslovima za životinje.
          </p>
        </div>
        ...
        <div className="rounded-2xl border p-6">
          ...
          <p className="mt-2 text-sm opacity-80">
            Smanjenje broja napuštenih životinja i povezivanje sa odgovornim
            udomiteljima.
          </p>
        </div>
      </section>
